...
print('Start MCPLP')
mc = MCPLP(target='workedunder', delta_p=0.05, m=50, max_literals=4, amplitude=2000, width=1500, level='INFO')
mc.load_data('data/imdb/imdb_facts.txt')
mc.load_examples('data/imdb/imdb_examples.txt')
...
with open('results/imdb_results.txt', 'w') as outfile:  
    json.dump(results, outfile)
    
with open('results/imdb_clauses.txt', 'w') as outfile:  
